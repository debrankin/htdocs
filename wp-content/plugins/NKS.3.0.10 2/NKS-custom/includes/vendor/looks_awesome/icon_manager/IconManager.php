...
//        $this->paths['fonts_styles'] = content_url('uploads/la_icon_sets/style.min.css'); // change 23.11.18
//        $this->paths['fonts_styles'] = '/' . wp_basename( $this->paths['baseurl'] ) . '/la_icon_sets/style.min.css';
...
//      add_action('admin_footer', array( $this, 'loadCollection' ));
        add_action('admin_footer-' . 'settings_page_nks-custom-options', array($this, 'loadCollection'));
    }
