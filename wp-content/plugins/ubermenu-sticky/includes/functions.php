...
function ubermenu_sticky_custom_styles( $styles ){
	...
	if( UM_STICKY()->sticky_apply() ){
		...
		$pfb = ubermenu_op( 'custom_prefix' , 'general' ).' ';

		$css = '';

		$css.= "\n/** UberMenu Sticky CSS **/\n";

		$css.= "$pfb.ubermenu.ubermenu-sticky, .ubermenu-responsive-toggle.ubermenu-sticky{ z-index:1000; }";

		$css.= "$pfb.ubermenu-sticky.ubermenu-sticky-full-width{ left:0; width:100%; max-width:100%; }\n";
		$css.= "$pfb.ubermenu-sticky-full-width.ubermenu-sticky .ubermenu-nav{ padding-left:1px; }\n";
		...
		$css.= "@media screen and (max-width: $breakpoint){ \n".
				"  $pfb.ubermenu-responsive-toggle.ubermenu-sticky{ height:43px; left:0; width:100% !important; } \n".
				"  $pfb.ubermenu.ubermenu-sticky{ margin-top:43px; left:0; width:100% !important; } \n";
				//"  .ubermenu-sticky-wrapper{ max-height:0; min-height:0 !important; } \n".

		//Force non-sticky on mobile viewport widths, even when not on mobile
		if( ubermenu_op( 'sticky_mobile' , 'main' ) != 'on' ){
			$css.= "\n	$pfb.ubermenu-responsive-toggle, $pfb.ubermenu, $pfb.ubermenu.ubermenu-sticky{position:relative !important; margin:0 !important; min-height:0 !important; }";
			$css.= "\n	$pfb.ubermenu.ubermenu-is-mobile.ubermenu-sticky.ubermenu-responsive-collapse{ max-height:0;}";
		}

			$css.= "  /* Mobile Sticky */\n";
			$css.= "  $pfb.ubermenu.ubermenu-is-mobile.ubermenu-sticky { min-height:400px; max-height:600px; overflow-y:auto !important; -webkit-overflow-scrolling:touch; }\n";
			$css.= "  $pfb.ubermenu.ubermenu-is-mobile.ubermenu-sticky > .ubermenu-nav{ height:100%; }\n";
			$css.= "  $pfb.ubermenu.ubermenu-is-mobile.ubermenu-sticky .ubermenu-active > .ubermenu-submenu-drop{ max-height:none; }\n";

		$css.= "}\n"; //End media query

		//Special Sticky Classes
		$css.= "/* Special Classes */ ";
		$css.= "$pfb.ubermenu .ubermenu-item.um-sticky-only{ display:none !important; } ";
		$css.= "$pfb.ubermenu.ubermenu-sticky .ubermenu-item-level-0.um-sticky-only{ display:inline-block !important; } ";
		$css.= "$pfb.ubermenu.ubermenu-sticky .ubermenu-submenu .ubermenu-item.um-sticky-only{ display:block !important; } ";
		$css.= "$pfb.ubermenu .ubermenu-item-level-0.um-unsticky-only{ display:inline-block !important; } ";
		$css.= "$pfb.ubermenu .ubermenu-submenu .ubermenu-item.um-unsticky-only{ display:block !important; } ";
		$css.= "$pfb.ubermenu.ubermenu-sticky .ubermenu-item.um-unsticky-only{ display:none !important; }\n";
...
@media screen and (min-width:783px){
  * html body { margin-top: 0 !important; }
  ...
  #wpadminbar .quicklinks .ab-sub-wrapper ul .ab-sub-wrapper { bottom: -7px; } }\n";
			...
			//$breakpoint = ubermenu_op( 'responsive_breakpoint' , 'general' );
			if( is_numeric( $breakpoint ) ) $breakpoint.= 'px';
			$css.= "@media screen and (min-width:783px){ .admin-bar $pfb.ubermenu.ubermenu-sticky, .admin-bar $pfb.ubermenu-responsive-toggle.ubermenu-sticky{ margin-top:32px; } }\n";
			$css.= "@media screen and (min-width:783px) and (max-width:$breakpoint){ .admin-bar $pfb.ubermenu.ubermenu-sticky{ margin-top:78px; } }\n";
			$css.= "@media screen and (min-width:600px) and (max-width:782px){ .admin-bar $pfb.ubermenu.ubermenu-sticky, .admin-bar $pfb.ubermenu-responsive-toggle.ubermenu-sticky{ margin-top:46px; } .admin-bar $pfb.ubermenu.ubermenu-sticky{ margin-top:89px; } }\n";
		}
