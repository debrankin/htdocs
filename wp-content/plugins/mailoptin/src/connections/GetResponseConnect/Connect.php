...
class Connect extends AbstractGetResponseConnect implements ConnectionInterface
{
    ...
    public function get_optin_fields($list_id = '')
    {
        try {
            ...
            $description      = sprintf(
                __( 'Please <a href="%s">activate your license key</a> to receive updates for <strong>%s</strong>. <a href="%s" target="_blank">Help</a>', 'wpbfpremium' ), $license_page_url, apply_filters( 'wpbf_premium_plugin_name', WPBF_PREMIUM_PRODUCT_NAME ), $docs_url
            );
